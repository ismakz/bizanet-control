  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="card p-6">
        ...
        <p className="mt-2 text-sm text-white/60">Connectez-vous avec votre numéro de téléphone.</p>
        ...
        <div className="mt-6 text-center text-sm">
          <p className="text-white/60">
            ...
            <a href="/register" className="text-cyan hover:underline hover:text-cyan/80 transition-colors">
